...
use Project\Domains\Client\Authentication\Infrastructure\Account\Repositories\Doctrine\Types\EmailType;
use Project\Domains\Client\Authentication\Infrastructure\Account\Repositories\Doctrine\Types\PasswordType;
use Project\Domains\Client\Authentication\Infrastructure\Account\Repositories\Doctrine\Types\UuidType;
...
#[ORM\Entity]
#[ORM\Table(name: 'client_auth_accounts')]
#[ORM\HasLifecycleCallbacks]
class Account extends AggregateRoot implements AuthenticatableInterface, DeviceableInterface
{
    ...
    public function changePassword(Password $password): self
    {
        $this->password = $password;
        $this->record(
            new AccountPasswordWasChangedDomainEvent(
                $this->uuid->value,
